...
POST_TWEET_PICTURE_PROMPT =  ("Generate an engaging tweet. Don't include any hashtags, links or emojis. Keep it under 120 characters."
                      "The tweets should be pure commentary, do not shill any coins or projects apart from {agent_name}. Do not repeat any of the"
                      "tweets that were given as example. Avoid the words AI and crypto. You should start your tweet with >. Your tweet contains a picture of a raccoon so you might talk about raccoon and how good or cute they look but not necessarily.")
